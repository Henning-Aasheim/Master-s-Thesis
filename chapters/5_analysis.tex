...
\SetCell{bg=Orange} -0.032 & 
\SetCell{bg=Orange} -0.063 & 
\SetCell{bg=Orange} -0.005 \\
& (0.132) & (0.134) & (0.122) & (0.122) & (0.122) & (0.101) \\
...
&  &  &  & (0.001) & (0.001) & (0.001) \\
Linkages (West) &  &  &  &  & -0.017 & -0.009 \\
&  &  &  &  & (0.011) & (0.008) \\
Electoral autocracy &  &  &  &  &  & 0.100** \\
&  &  &  &  &  & (0.032) \\
Electoral democracy &  &  &  &  &  & 0.269*** \\
&  &  &  &  &  & (0.036) \\
Liberal democracy &  &  &  &  &  & 0.310*** \\
&  &  &  &  &  & (0.037) \\
...
\SetCell{bg=Orange} 0.159x & 
\SetCell{bg=Orange} 0.119 \\
& (0.091) & (0.090) & (0.092) & (0.093) & (0.092) & (0.073) \\
...
\SetCell{bg=Orange} -0.291 & 
\SetCell{bg=Orange} -0.256 \\
...
\SetCell{bg=Orange} 0.108 & 
\SetCell{bg=Orange} 0.105 \\
& (0.080) & (0.081) & (0.085) & (0.089) & (0.089) \\
Electoral autocracy & 0.099** & 0.102** & 0.096** & 0.099** & 0.099** \\
