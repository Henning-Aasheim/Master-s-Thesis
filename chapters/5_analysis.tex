...
Another thing to note is that the coefficient for linkages to the West is consistently negative and significant. This is the same as in Table \ref{tab:h1_lead}. The effect size is negligible, however, so this is likely to be an effect we find because we have enough data, not because of an actual effect. This is to be discussed in the next chapter.
